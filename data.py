...
publications = [
  ...
  },
  {
    ...
    "journal": "preprint",
    "link": None,
    "arxiv": "https://arxiv.org/abs/2605.20327",
    "pdf": "Nixon+2026.pdf",
    "data": None,
    "fig": "Nixon+2026.png",
    ...
    The stellar debris is initially placed on highly elliptical orbits, and a longstanding question in TDE theory is: How does the stellar debris circularize into a disc and accrete? 
    The originally proposed answer to this question is self-intersection shocks, where relativistic apsidal precession results in a strong collision between the incoming and outgoing material. 
    However, global simulations of TDEs tend to find enhanced hydrodynamical dissipation prior to any intersections of the debris orbits, 
    with the material "fanning out" into a wide-angle and partially-unbound outflow upon passing through pericenter. 
    ...
    We discuss possible resolutions to these issues as well as the implications of our findings in the context of observations.
    """
  },
  {
    "id": "Andalman+2026a",
    ...
    "journal": "OJAp",
    "link": "https://astro.theoj.org/article/162785-resolving-the-debate-about-nozzle-shocks-in-tidal-disruption-events",
    ...
    """,
    "abstract": r"""
    When a star passes within the Roche limit of a supermassive black hole (SMBH), it is pulled apart by the BH's tidal field in a tidal disruption event (TDE). 
    The resulting flare is powered by the circularization and accretion of bound stellar debris, which initially returns to the BH on eccentric orbits in a thin debris stream. 
    ...
    We develop an idealized model for the debris stream evolution combining 3D smoothed-particle hydrodynamics simulations, the semi-analytic affine model, and 1D finite-volume hydrodynamic simulations. 
  ...
  },
  {
    ...
    "authors_long": "Z. L. Andalman, M. T. P. Liska, A. Tchekhovskoy, E. R. Coughlin, & N. Stone",
